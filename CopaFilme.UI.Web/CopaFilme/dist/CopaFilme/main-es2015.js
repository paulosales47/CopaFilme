...
let BannerSelecaoComponent = class BannerSelecaoComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let BannerVitoriaComponent = class BannerVitoriaComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let FilmesVencedoresComponent = class FilmesVencedoresComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SelecaoFilmeComponent = class SelecaoFilmeComponent {
    ...
    AlterarListaSelecionados(filmeSelecionado) {
    ...
    GerarCampeonato() {
        this.filmeService.RealizarCampeonato(this.filmesSelecionados).subscribe((filmesRetorno) => this.filmesVencedores = filmesRetorno);
    }
};
...
let FilmeService = class FilmeService {
    ...
    RealizarCampeonato(filmesSelcionados) {
